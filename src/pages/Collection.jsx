        ...
        <div className="max-w-[640px] mb-20">
          ...
          <FadeInUp>
            <p className="font-light leading-[1.8] text-[#2C2C2C]/70">
              These are the first results out of the kiln, so the glazes
              aren&rsquo;t listed for sale yet. If one calls to you, email me and
              we&rsquo;ll sort it out over Venmo &mdash; or{" "}
              <Link to="/shop" className="underline underline-offset-4 hover:opacity-60 transition-opacity">
                start a commission
              </Link>
              .
            </p>
